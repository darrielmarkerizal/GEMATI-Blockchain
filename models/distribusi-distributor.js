...
const PenerimaanGudang = require("./penerimaan-gudang");
...
DistribusiDistributor.belongsTo(Distributor, {
    foreignKey: "id_distributor",
    as: "distributor",
});
DistribusiDistributor.belongsTo(PenerimaanGudang, {
    foreignKey: "id_penerimaan",
